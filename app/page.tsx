...
export default function Home() {
   return (
      <>
         <Head>
            <title>
               J-iDev - Création de sites web, maintenance & SEO | Agence Web
               Professionnelle
            </title>
            <meta
               name="description"
            ...
            <meta
               ...
               content="Agence web professionnelle spécialisée dans la création de sites web responsive, maintenance et SEO. Solutions sur mesure pour votre présence en ligne."
            />
            <meta
               property="og:image"
               content="https://j-idev.com/images/og-image.jpg"
            />
            ...
            <meta
               ...
               content="https://j-idev.com/images/twitter-image.jpg"
            />
            ...
            <script
               ...
               dangerouslySetInnerHTML={{
                  __html: JSON.stringify({
                     ...
                     description:
                        "Agence web professionnelle spécialisée dans la création de sites web responsive, maintenance et SEO",
                     potentialAction: {
                        "@type": "SearchAction",
                        target:
                           "https://j-idev.com/search?q={search_term_string}",
