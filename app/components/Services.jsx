    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="border-b-4 border-green-200">création de sites web</span>, de{" "}
          <span className="border-b-4 border-yellow-200">référencement (SEO)</span>, mais aussi la{" "}
          <span className="border-b-4 border-orange-400">maintenance & la refonte</span> de votre site actuel !
        </motion.h2>
